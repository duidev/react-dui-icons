...
const SortSolidFillComponent = props => {
...
SortSolidFillComponent.defaultProps = {
  color: '#0C0F0F',
  size: '24'
};

const SortSolidFill = React.memo(SortSolidFillComponent);

export default SortSolidFill;
