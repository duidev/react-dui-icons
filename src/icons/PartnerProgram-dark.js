...
const PartnerProgramDarkComponent = props => {
...
PartnerProgramDarkComponent.defaultProps = {
  color: '#0C0F0F',
  size: '24'
};

const PartnerProgramDark = React.memo(PartnerProgramDarkComponent);

export default PartnerProgramDark;
