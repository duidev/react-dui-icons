...
const NewTwitterWhiteComponent = props => {
...
NewTwitterWhiteComponent.defaultProps = {
  color: '#0C0F0F',
  size: '24'
};

const NewTwitterWhite = React.memo(NewTwitterWhiteComponent);

export default NewTwitterWhite;
