...
const YoutubeBgwhiteComponent = props => {
...
YoutubeBgwhiteComponent.defaultProps = {
  color: '#0C0F0F',
  size: '24'
};

const YoutubeBgwhite = React.memo(YoutubeBgwhiteComponent);

export default YoutubeBgwhite;
