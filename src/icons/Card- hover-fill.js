...
const CardHoverFillComponent = props => {
  ...
  return (
    ...
    >
      ...
      <path
        d="M14.02 3.884a1.929 1.929 0 012.408-1.28l3.688 1.13a1.928 1.928 0 011.28 2.408l-1.13 3.688a1.929 1.929 0 01-2.408 1.28L14.17 9.981a1.928 1.928 0 01-1.28-2.409l1.13-3.688z"
        fill="#00DDD3"
      ></path>
    </svg>
  );
...
CardHoverFillComponent.defaultProps = {
  color: '#0C0F0F',
  size: '24'
};

const CardHoverFill = React.memo(CardHoverFillComponent);
