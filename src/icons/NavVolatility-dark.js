...
const NavVolatilityDarkComponent = props => {
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 6.752a.75.75 0 01.75.75v.3a2.5 2.5 0 011.285 4.2 2.5 2.5 0 01-1.285 4.2v.3a.75.75 0 01-1.5 0v-.25h-1.06a.94.94 0 01-.94-.94V8.691c0-.519.421-.94.94-.94h1.06v-.25a.75.75 0 01.75-.75zm0 8h.25a1 1 0 100-2h-1.5v2H12zm-1.25-5.5h1.5a1 1 0 110 2h-1.5v-2z"
        fill="#00D5C8"
      ></path>
      <path
        fillRule="evenodd"
...
NavVolatilityDarkComponent.defaultProps = {
  color: '#0C0F0F',
  size: '24'
};

const NavVolatilityDark = React.memo(NavVolatilityDarkComponent);

export default NavVolatilityDark;
