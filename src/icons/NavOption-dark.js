...
const NavOptionDarkComponent = props => {
...
NavOptionDarkComponent.defaultProps = {
  color: '#0C0F0F',
  size: '24'
};

const NavOptionDark = React.memo(NavOptionDarkComponent);

export default NavOptionDark;
