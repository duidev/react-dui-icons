...
const MailBgwhiteComponent = props => {
...
MailBgwhiteComponent.defaultProps = {
  color: '#0C0F0F',
  size: '24'
};

const MailBgwhite = React.memo(MailBgwhiteComponent);

export default MailBgwhite;
