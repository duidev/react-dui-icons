...
const YoutubeBlackComponent = props => {
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="#fff"
      ></path>
      <path d="M10.398 14.4l4.157-2.4-4.157-2.4v4.8z" fill="#000"></path>
    </svg>
  );
};

YoutubeBlackComponent.defaultProps = {
  color: '#0C0F0F',
  size: '24'
};

const YoutubeBlack = React.memo(YoutubeBlackComponent);
