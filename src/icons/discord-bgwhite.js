...
const DiscordBgwhiteComponent = props => {
...
DiscordBgwhiteComponent.defaultProps = {
  color: '#0C0F0F',
  size: '24'
};

const DiscordBgwhite = React.memo(DiscordBgwhiteComponent);

export default DiscordBgwhite;
