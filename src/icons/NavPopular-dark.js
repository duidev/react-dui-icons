...
const NavPopularDarkComponent = props => {
...
NavPopularDarkComponent.defaultProps = {
  color: '#0C0F0F',
  size: '24'
};

const NavPopularDark = React.memo(NavPopularDarkComponent);

export default NavPopularDark;
