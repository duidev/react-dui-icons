...
const AntDesignBlackComponent = props => {
...
AntDesignBlackComponent.defaultProps = {
  color: '#0C0F0F',
  size: '24'
};

const AntDesignBlack = React.memo(AntDesignBlackComponent);

export default AntDesignBlack;
