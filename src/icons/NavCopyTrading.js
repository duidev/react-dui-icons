...
const NavCopyTradingComponent = props => {
...
NavCopyTradingComponent.defaultProps = {
  color: '#0C0F0F',
  size: '24'
};

const NavCopyTrading = React.memo(NavCopyTradingComponent);

export default NavCopyTrading;
