...
const NavOtcDarkComponent = props => {
  ...
  return (
    ...
    >
      ...
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M17.828 21.34a.75.75 0 010-1.06l.15-.15h-3.577a.75.75 0 110-1.501h5.389a.75.75 0 01.53 1.28l-1.431 1.432a.75.75 0 01-1.061 0z"
        fill="#00D5C8"
      ></path>
      <path
        fillRule="evenodd"
...
NavOtcDarkComponent.defaultProps = {
  color: '#0C0F0F',
  size: '24'
};

const NavOtcDark = React.memo(NavOtcDarkComponent);

export default NavOtcDark;
