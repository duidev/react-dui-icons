...
const NavDftEcosystemComponent = props => {
...
NavDftEcosystemComponent.defaultProps = {
  color: '#0C0F0F',
  size: '24'
};

const NavDftEcosystem = React.memo(NavDftEcosystemComponent);

export default NavDftEcosystem;
